...
// and never imports locale.ts.

import type { Formats, Translate } from "./types.ts";

export function formatShare(value: number, total: number, t: Translate, fmt: Formats): string {
