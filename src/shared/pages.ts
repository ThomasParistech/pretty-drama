...
// The keys of PAGES, so a page name is checked wherever one travels.
export type PageKey = keyof typeof PAGES;

export function pageLabelKey(page: PageKey): string {
  return `page.${page}.label`;
}

export function pageDescKey(page: PageKey): string {
...
export function chooserHref(page: PageKey): string {
  return RESPO_ONLY.has(page) ? "../../respo.html" : "../../index.html";
}
