// English catalogue. Mirrors fr.ts key for key, which locales/parity.test.ts
...
export const EN: Catalogue = {
  ...
  // are data (see fr.ts, which also carries why the button is named here and not in
