...
import { setSeekDragging } from "./useScrollToActiveCard.ts";
...
export default function ProgressBar({
  ...
  // smooth scrolling for a fast follow (`setSeekDragging`, useScrollToActiveCard.ts).
