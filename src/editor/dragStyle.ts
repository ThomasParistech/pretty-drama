...
const px = (value: number | undefined) => (value ? Math.round(value) : 0);

export function dragStyle(
  ...
  return {
    ...
    // Same treatment as the transform: dnd-kit hands null at rest, and React writes no
    // declaration for either null or undefined.
