...
import { CHARACTER_COLOR_KEYS, CHARACTER_COLORS } from "../shared/characterColors.ts";
import { t } from "../shared/locale.ts";
import CountBadge from "./CountBadge.tsx";
import { newId } from "./reducer.ts";
        ...
        <ul className="character-list">
          {characters.map((c) => (
            <CharacterItem
              ...
              onRename={(name: string) => dispatch({ type: "RENAME_CHARACTER", id: c.id, name })}
              onSetColor={(color: string) =>
                dispatch({ type: "SET_CHARACTER_COLOR", id: c.id, color })
              }
